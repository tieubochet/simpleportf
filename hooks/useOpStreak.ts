...
import { streakContractAddress, streakContractAbi } from '../services/opStreakContract';
...
// Optimism Chain details
const OP_CHAIN_ID = '0xa'; // 10 in hex
const OP_CHAIN_ID_DECIMAL = 10;
...
export function useOpStreak() {
    ...
    const connectWallet = useCallback(async () => {
        ...
        try {
            ...
            if (network.chainId !== BigInt(OP_CHAIN_ID_DECIMAL)) {
