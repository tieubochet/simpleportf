...
const CACHE_NAME = 'crypto-portfolio-cache-v12'; // Cache version bump
const URLS_TO_CACHE = [
  '/',
  '/index.html',
  '/index.tsx',
...
self.addEventListener('fetch', event => {
  ...
  if (event.request.url.includes('fapi.coinglass.com') || event.request.url.includes('api.coingecko.com') || event.request.url.includes('api.alternative.me') || event.request.url.includes('esm.sh') || event.request.url.includes('cdn.tailwindcss.com')) {
