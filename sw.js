...
const CACHE_NAME = 'crypto-portfolio-cache-v26'; // Cache version bump
const URLS_TO_CACHE = [
  '/',
  '/index.html',
  '/index.tsx',
...
self.addEventListener('fetch', event => {
  ...
  if (
    ...
    event.request.url.includes('rpc.ankr.com') ||
    event.request.url.includes('eth-mainnet.public.blastapi.io') ||
