...
const PerformanceChart: React.FC<PerformanceChartProps> = ({ portfolioData, isLoading, timeRange, setTimeRange, isPrivacyMode, theme }) => {
                            ...
                            <Legend 
                                ...
                                formatter={(value, entry) => {
                                    if (value === 'portfolioValue') {
                                      return <span style={{ color: chartColors.legend }} className="font-medium">Portfolio Value</span>;
                                    }
                                    return <span style={{ color: chartColors.legend }} className="font-medium">{value}</span>;
                                }}
                            />
