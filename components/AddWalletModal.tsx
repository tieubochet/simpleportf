    ...
    >
      ...
      >
        ...
        <div className="p-6 bg-slate-800/50 border-t border-slate-700 rounded-b-lg flex justify-end space-x-4">
          ...
          <button onClick={handleSave} disabled={!name.trim()} className="bg-cyan-500 hover:bg-cyan-600 text-white font-bold py-2 px-4 rounded-lg transition-colors disabled:bg-slate-700 disabled:cursor-not-allowed">
            Create Wallet
          </button>
        </div>
      </div>
