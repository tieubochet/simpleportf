  ...
  return (
    <header className="flex flex-col md:flex-row items-center justify-between mb-8">
      ...
      <div className="flex items-center space-x-2">
        ...
        <button onClick={onExport} className="flex items-center space-x-2 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-800 dark:text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-300">
